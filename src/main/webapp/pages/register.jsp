        ...
        <div class="container">
            ...
            <form method="POST" action="/monapp/users" id="registerForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input class="form-control" type="text" placeholder="Enter Email" name="email" required autocomplete="off">
                    </div>
                </div>
                ...
                <!-- Success message -->
                <div class="alert alert-success col-8 offset-2" role="alert" style="display: none;" id="success_message">Success <i class="glyphicon glyphicon-thumbs-up"></i> Success!.</div>
